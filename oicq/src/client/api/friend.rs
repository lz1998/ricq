...
use oicq_core::command::long_conn::OffPicUpResp;
use oicq_core::command::oidb_svc::music::{MusicShare, MusicType, SendMusicTarget};
use oicq_core::command::{friendlist::*, profile_service::*};
use oicq_core::hex::encode_hex;
use oicq_core::highway::BdhInput;
use oicq_core::msg::elem::FriendImage;
use oicq_core::msg::MessageChain;
use oicq_core::pb;
use oicq_core::structs::FriendAudio;
use oicq_core::structs::{FriendInfo, MessageReceipt};
