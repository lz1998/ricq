...
use oicq_core::command::multi_msg::gen_forward_preview;
use oicq_core::msg::elem::RichMsg;
use oicq_core::pb::short_video::ShortVideoUploadRsp;
use oicq_core::structs::{ForwardMessage, MessageNode};

use crate::client::Group;
use crate::structs::{ImageInfo, VideoInfo};
use crate::{RQError, RQResult};
use oicq_core::command::img_store::GroupImageStoreResp;
use oicq_core::command::oidb_svc::music::{MusicShare, MusicType, SendMusicTarget};
use oicq_core::command::{friendlist::*, oidb_svc::*, profile_service::*};
use oicq_core::common::group_code2uin;
use oicq_core::hex::encode_hex;
use oicq_core::highway::BdhInput;
use oicq_core::msg::elem::{Anonymous, GroupImage};
use oicq_core::msg::MessageChain;
use oicq_core::pb;
use oicq_core::structs::GroupAudio;
use oicq_core::structs::{GroupInfo, GroupMemberInfo, MessageReceipt};
