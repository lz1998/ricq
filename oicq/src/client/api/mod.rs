...
use oicq_core::common::{group_code2uin, RQAddr};
use oicq_core::highway::BdhInput;
use oicq_core::structs::ForwardMessage;

use crate::jce::SvcDevLoginInfo;
use crate::{RQError, RQResult};
use oicq_core::command::message_svc::MessageSyncResponse;
use oicq_core::command::oidb_svc::*;
use oicq_core::pb;
use oicq_core::structs::Status;
use oicq_core::structs::SummaryCardInfo;
