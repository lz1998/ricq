...
use oicq_core::common::RQAddr;
use tokio::sync::{broadcast, RwLock};
use tokio::sync::{oneshot, Mutex};

use crate::structs::Group;
use oicq_core::command::online_push::GroupMessagePart;
use oicq_core::command::profile_service::GroupSystemMessages;
use oicq_core::protocol::packet::Packet;
use oicq_core::structs::{AccountInfo, AddressInfo, FriendInfo, OtherClientInfo};
use oicq_core::Engine;
pub use oicq_core::Token;
...
pub struct Client {
    ...
    highway_session: RwLock<oicq_core::highway::Session>,
