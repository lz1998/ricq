...
impl From<Elem> for MsgElem {
    fn from(e: Elem) -> Self {
        ...
        match e.clone() {
            elem::Elem::SrcMsg(src_msg) => {
                if !src_msg.orig_seqs.is_empty() {
                    return Self::Reply {
            ...
            elem::Elem::VideoFile(video_file) => {
            ...
            elem::Elem::CustomFace(custom_face) => {
            ...
            elem::Elem::MarketFace(market_face) => {
            ...
            elem::Elem::NotOnlineImage(not_online_image) => {
            ...
            elem::Elem::QqWalletMsg(qq_wallet_msg) => {
                let aio_body = qq_wallet_msg.aio_body.unwrap();
            ...
            elem::Elem::CommonElem(common_elem) => match common_elem.service_type() {
                3 => {
                    if let Ok(flash) =
