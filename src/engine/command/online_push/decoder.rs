...
use crate::engine::command::online_push::*;
use crate::{jce, pb, RQError, RQResult};

impl super::super::super::Engine {
    // 解析群消息分片 长消息需要合并
    // OnlinePush.PbPushGroupMsg
    pub fn decode_group_message_packet(&self, payload: Bytes) -> Result<GroupMessagePart, RQError> {
    ...
    pub fn msg_type_0x210_subb3_decoder(&self, protobuf: Bytes) -> Result<NewFriendEvent, RQError> {
    ...
    pub fn msg_type_0x210_subd4_decoder(
        &self,
        protobuf: Bytes,
    ) -> Result<GroupLeaveEvent, RQError> {
        let d4 =
    ...
    pub fn msg_type_0x210_sub27_decoder(&self, protobuf: Bytes) -> Result<Sub0x27Event, RQError> {
    ...
    pub fn msg_type_0x210_sub122_decoder(
        &self,
        protobuf: Bytes,
    ) -> Result<FriendPokeNotifyEvent, RQError> {
    ...
    pub fn msg_type_0x210_sub44_decoder(
        &self,
        protobuf: Bytes,
    ) -> Result<GroupMemberNeedSync, RQError> {
        let b44 =
