...
use crate::engine::binary::BinaryWriter;
use crate::engine::command::wtlogin::builder::utils::*;
use crate::engine::command::wtlogin::tlv_writer::*;
...
mod utils {
    ...
    use crate::engine::protocol::device::Device;
    use crate::pb;
